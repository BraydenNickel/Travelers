...
export default function GameScenarios() {
  ...
  const scenarios = [
    {
      id: 'EncounterGoblin', //Dungeon Scenario, Common Enemy
      ...
      id: 'MainHallwayStart', //Dungeon Scenario, First Screen
      ...
      id: 'MainHallway', //Dungeon Scenario, Common Hallway
      image: Image.resolveAssetSource(hallwayImage).uri,
      ...
      id: 'TreasureRoom', //Dungeon Scenario, Win Condition
      image: Image.resolveAssetSource(forestImage).uri,
      ...
      id: 'BossEncounter', //Dungeon Scenario, Boss Encounter
      ...
      id: 'TrinketRoom', //Dungeon Scenario, Stat Increase
    ...
    {
      id: 'VictoryGoblin', //Dungeon Scenario, Victory Screen Goblin
      image: Image.resolveAssetSource(forestImage).uri,
    ...
    {
      id: 'VictoryMinotaur', //Dungeon Scenario, 
      image: Image.resolveAssetSource(forestImage).uri,
